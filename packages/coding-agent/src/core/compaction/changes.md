...
A real reproducer: `~/.senpi/agent/sessions/--Users-yeongyu-local-workspaces-sanepi-mono--/2026-04-28T01-50-51-950Z_*.jsonl` contains two consecutive compactions on a tiny Kimi K2.6 hello session, both stored as all-`None.` summaries with `tokensBefore` of 11527 and 11690.
