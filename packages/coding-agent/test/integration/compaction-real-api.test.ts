...
import { API_KEY, createTestResourceLoader, getRealAuthStorage, resolveApiKey } from "../utilities.js";
...
describe.skipIf(!process.env.PI_RUN_INTEGRATION)("Compaction with thinking models (Antigravity)", () => {
	let session: AgentSession;
	let tempDir: string;
	let apiKey: string;
